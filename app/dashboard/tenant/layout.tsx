    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50 text-gray-900">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 shadow-sm fixed h-full z-10">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <Link href="/dashboard/tenant/invoices" className="flex items-center gap-3 px-3 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg font-medium transition-colors">
            <FileText className="w-5 h-5" />
            Hóa đơn của tôi
          </Link>
          <Link href="/dashboard/tenant/contracts" className="flex items-center gap-3 px-3 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg font-medium transition-colors">
          ...
          <Link href="/dashboard/tenant/settings" className="flex items-center gap-3 px-3 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg font-medium transition-colors">
